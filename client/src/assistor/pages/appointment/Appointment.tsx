...
import { rows } from "../../../doctor/contexts/utils.context";
import { formatDateToHourAndDay } from "../../../utils/formatDate.util";

import type { AppointmentModel } from "../../../models/Appointment.model";
import DoctorDetailAppointment from "../../../doctor/components/appointment/detail.appointment";
import DoctorTablePagination from "../../../doctor/components/paginations/table.pagination";
...
const AppointmentPage = () => {
    ...
    const [appointment, setAppointment] = useState<AppointmentModel>({} as AppointmentModel);
        ...
        <main className="appointment-page p-4 sm:p-6">
            <div className="appointment-page__wrap max-w-full">
                    ...
                    <div className="appointment__filter space-y-4">
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
                            ...
                            <div className="space-y-1">
                                ...
                                >
                                    <option value="default">Số hàng</option>
                                    {rows.map((row) => (
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="flex flex-wrap gap-2">
                                ...
                                <button 
                                    className="px-3 py-1 bg-red-100 text-red-700 hover:bg-red-200  rounded-full text-xs font-medium  transition-colors"
                            ...
                            <tbody className="divide-y divide-gray-100">
                                {appointments.slice((page - 1) * row, page * row).map((appointment, idx) => (
                                    <tr key={appointment.id} className={`${idx % 2 === 0 ? 'bg-gray-50' : 'bg-white'} hover:bg-blue-50 transition-colors`}>
                                        ...
                                        <td className="px-4 py-3 text-sm text-gray-600">{formatDateToHourAndDay(new Date(appointment.time))}</td>
                ...
                <div className="appointment__pagination mt-6 flex flex-col sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <DoctorTablePagination array={appointments} page={page} setPage={setPage} row={row} />
                </div>
            </div>
