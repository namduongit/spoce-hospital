...
const NurseSection = (props: NurseSectionProps) => {
  ...
  return (
    <div className="group nurse-section h-full bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden border border-gray-100 hover:border-blue-200">
      ...
      <div className="p-5">
        <div className="mb-4">
          <h3 className="font-bold text-xl text-gray-800 mb-1 group-hover:text-blue-600 transition-colors truncate">
            {fullName}
          </h3>
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between py-2 border-b border-gray-100">
            <div className="flex items-center">
              ...
              <span className="text-sm text-gray-600 hidden md:block">Giới tính</span>
            </div>
          ...
          {phone && (
            <div className="flex items-center justify-between py-2">
              <div className="flex items-center">
                ...
                <span className="text-sm text-gray-600 hidden md:block">Điện thoại</span>
              </div>
