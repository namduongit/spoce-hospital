...
public class _AuthController {
    ...
    public ResponseEntity<RestResponse<ValidResponse>> handleValid(Authentication authentication) {
        ValidResponse validResponse = this.authService.handleValid(authentication);
